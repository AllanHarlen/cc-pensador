...
4. **Layout** — estrutura de páginas, regiões fixas (header/sidebar/footer), scroll; garantir que as fixtures de componentes consumam apenas CSS local, sem dependências de CDN externas.
