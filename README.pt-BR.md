...
└── <slug-da-demanda>-vN/          ← ex.: login-social-v1
    ...
    └── design-systems/<id>/       ← design system gerado (source/ + resolved/: tokens.css, DESIGN.md, components.html, preview/, …)
```
